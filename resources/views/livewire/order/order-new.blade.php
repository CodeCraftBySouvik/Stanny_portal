                        ...
                        <div wire:ignore.self class="modal fade" id="skipModal" tabindex="-1"
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <form wire:submit.prevent="skipOrder">
                        ...
                        <div class="row align-items-center mb-3">
                            ...
                            {{-- <div class="col-md-4 {{ $auth->is_super_admin==1 ? "" : " d-none" }}"> --}}
                                <div class="col-md-4">
                                    ...
                                    <div class="text-danger error-message">{{ $errorMessage['selectedBusinessType'] }}
                                    </div>
                                    @endif
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-3">
                                    ...
                                    <div class="text-danger error-message">{{
                                        $errorMessage['alternative_phone_number_1'] }}
                                    </div>
                                    @endif
                                    <div class="form-check-label-group">
                                ...
                                <div class="mb-3 col-md-3">
                                    ...
                                    <div class="text-danger error-message">{{
                                        $errorMessage['alternative_phone_number_2'] }}
                                    </div>
                                    @endif
                                    <div class="form-check-label-group">
                                    ...
                                    <div class="admin__content">
                                        ...
                                        <content>
                                            ...
                                            <div class="row mb-2 align-items-center">
                                                ...
                                                <div class="col-9">
                                                    <input type="text" id="billing_landmark"
                                                        class="form-control form-control-sm"
                                                        wire:model="billing_landmark" value="">
                                            ...
                                            <div class="row mb-2 align-items-center">
                                                ...
                                                <div class="col-3">
                                                    <input type="text" id="billing_pin"
                                                        class="form-control form-control-sm" wire:model="billing_pin"
                                                        value="">
                                                    @if(isset($errorMessage['billing_pin']))
                                                    <div class="text-danger error-message">{{
                                                        $errorMessage['billing_pin'] }}
                                                    </div>
                                                    @endif
                                                </div>
                                            </div>
                            ...
                            <div class="row align-items-top mt-3">
                                ...
                                <div class="col-md-2 col-12 mb-3">
                                    ...
                                    <select wire:model="items.{{ $index }}.category"
                                        ...
                                        @if (isset($items[$index]['categories']) && count($items[$index]['categories'])
                                        > 0)
                                ...
                                <div class="mb-3 col-md-2">
                                    ...
                                    <div class="col-md-2 col-12 mb-3 position-relative">
                                        ...
                                        <input type="text" wire:model="items.{{ $index }}.searchTerm"
                                            ...
                                            class="form-control form-control-sm" placeholder="Search by fabric name"
                                            id="searchFabric_{{ $index }}" autocomplete="off">
                                    ...
                                    <div class="col-md-2 col-12 mb-3">
                                        ...
                                        <div class="text-danger error-message">{{ session('errorPrice.' . $index) }}
                                        </div>
                                        @endif
                                ...
                                <div class="row align-items-end my-4">
                                    ...
                                    <div class="col-md-4 col-12">
                                        <table>
                                            ...
                                            <tr>
                                                <td class="w-70"><label class="form-label"><strong>Air
                                                            Mail</strong></label>
                                                </td>
                                                <td>
                                                    <!-- Sub Total -->
