        ...
        try {
            ...
            'data_details' => json_encode([
                ...
                'customer' => [
                    ...
                    'employee_rank' => $user->employee_rank,
                    'email' => $user->email,
                    'dob' => $user->dob,
                    'phone' => $user->phone,
                    'alternative_phone_number_1' => $user->alternative_phone_number_1,
                    'alternative_phone_number_2' => $user->alternative_phone_number_2,
                    'business_type' => $user->business_type,
                    'country_id' => $user->country_id,
                    'country_code' => $user->country_code,
                    'country_code_phone' => $user->country_code_phone,
                    'country_code_alt_1' => $user->country_code_alt_1,
                    'country_code_alt_2' => $user->country_code_alt_2,
                ],
                'billing_address' => [
                    'address' => $this->billing_address,
                    'landmark' => $this->billing_landmark,
                ...
                'order_items' => collect($this->items)->map(function ($item) {
                    return [
                        'product_id' => $item['product_id'],
                        ...
                        'quantity' => $item['quantity'],
                        'price' => $item['price'],
                        'collection' => $item['selected_collection'],
                        'category' => $item['selected_category'],
                        'fabric' => $item['selected_fabric'],
                        'catalogue_id' => $item['selectedCatalogue'] ?? null,
                        'page_number' => $item['page_number'] ?? null,
                        'page_item' => $item['page_item'] ?? null,
                        'fitting' => $item['fitting'] ?? null,
                        'priority' => $item['priority'],
                        'expected_delivery_date' => $item['expected_delivery_date'] ?? null,
                        'measurements' => collect($item['measurements'])->map(function ($m) {
                            return [
                                'title' => $m['title'] ?? '',
                ...
                'whatsapp_numbers' => [
                    'isWhatsappPhone' => $this->isWhatsappPhone ? $this->phone : null,
                    'isWhatsappAlt1' => $this->isWhatsappAlt1 ? $this->alternative_phone_number_1 : null,
                    'isWhatsappAlt2' => $this->isWhatsappAlt2 ? $this->alternative_phone_number_2 : null,
                ],
            ]),
        ]);
